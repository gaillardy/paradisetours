<?php include 'templates/header.php'; ?>
    ...
    <div class="hero-wrap js-fullheight" style="background-image: url('/assets/images/circuits/meva.jpg');">
        <div class="overlay"></div>
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
                <div class="col-md-9 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                    <h1 class="mf-3 bread" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Tour Meva</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <main>
        <section class="content-section">
            <h2>JOUR 1: NOSY BE – ANKIFY – RÉSERVE SPÉCIALE DE L’ANKARANA</h2>
        ...
        <section class="buttons-section">
            <a href="#" class="btn btn-outline-primary" download="/assets/documents/Tour-Salama-fr.pdf">Télécharger le PDF</a>
