<?php include 'templates/header.php'; ?>
    ...
    <main>
        <section class="content-section">
            <h2>JOUR 1 : ARRIVÉE À NOSY BE</h2>
            <p>
                Accueil à l'Aéroport International Fascene
            ...
            <h5>Visite :  NOSY KOMBA et TANIKELY</h5>
            <p>
            ...
            <h2>JOUR 3: NOSY BE</h2>
            <h5>Visite : ÎLE D'IRANJA</h5>
            <p>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="service-list">
                        ...
                        <ul>
                            <li>Déjeuner : jour 4 si les clients restent à l'hôtel</li>
