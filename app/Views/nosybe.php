...
<!-- Navigation Personnalisée -->
    <nav class="custom-tabs">
        ...
        <a href="/<?= $lang?>/savoir " class="<?php if($currentRoute === "/$lang/savoir"){echo 'active';} else {echo '';}?>"><?= $translations['282'] ?></a>
    </nav>

    <!-- Contenu -->
    <div class="content">
    <h2 class="guide-heading"><i class="fas fa-history"></i><?= $translations['283'] ?></h2>
                    <p class="mb-3">
                      <?= $translations['284'] ?>
                    </p>
